...
* Helm 是 K8S 的包管理工具，如 yum、apt，可以方便將之前打包好的 yaml 文件部署到 K8S 上
...
4. 在 `/home/user/abc/templates/` 中創建兩個檔案 [deployment.yaml]()、[service.yaml]()
...
1. 將 [mychart2]() 資料夾利用 winscp 放入 vm1 中
